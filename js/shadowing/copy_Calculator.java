package com.houarizegai.calculaor;
...
public class Calculator {
  ...
  private boolean addWrite = ture; // Connect numbers in display
  ...
  Public Calculator() {
    ...
    comboTheme = initCombo(new Strint[]{"Simple", "Colored", "DarkTheme"}, 230, 30, "Theme", themeSwitchEventConsumer);
    
    comboCalcType = initCombo(new Sritn[]{"Standard", "Scientific"}, 20, 30, "Calculator type", calcTypeSwithchEventConsumer)'
